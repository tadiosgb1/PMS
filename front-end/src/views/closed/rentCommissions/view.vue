  ...
  <div class="p-6 min-h-screen bg-gray-100">
    ...
    <div class="bg-white shadow-lg overflow-hidden rounded-lg">
      ...
      <div class="flex flex-col sm:flex-row justify-between items-center px-6 py-4 bg-primary">
        <h1 class="text-2xl font-bold text-white mb-2 sm:mb-0">Rent Commissions</h1>
        <button
        ...
        <table class="w-full text-left min-w-[600px]">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-2">{{ commission.rent || commission.rent }}</td>
      ...
      <div class="md:hidden space-y-4 mt-4">
        ...
        >
          <div class="flex justify-between items-center mb-2">
            <span class="font-semibold">Total: {{ commission.total_commission }}</span>
          ...
          <p><span class="font-semibold">Rent:</span> {{ commission.rent || commission.rent }}</p>
        </div>
      </div>
    </div>
