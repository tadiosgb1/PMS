    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6 flex flex-col md:flex-row md:space-x-6">
      ...
      <div class="flex-1">
        ...
        <div class="flex space-x-4 mb-4">
          ...
          <button @click="applyUserFilter" class="self-end px-3 py-1 bg-indigo-600 text-white rounded hover:bg-indigo-700 text-sm">Apply</button>
        </div>
        ...
        <div>
          ...
          <button @click="downloadUsers" class="mt-2 px-3 py-1 text-sm bg-blue-600 text-white rounded hover:bg-blue-700">⬇ Export</button>
        </div>
      </div>
        ...
        <div>
          ...
          <div v-if="activePaymentTab === 'subscription'" class="mb-4">
            ...
            <div class="flex space-x-4 mb-2">
              ...
              <button @click="applySubscriptionFilter" class="self-end px-3 py-1 bg-teal-600 text-white rounded hover:bg-teal-700 text-sm">Apply</button>
            </div>
            <p class="text-xl font-bold mb-2">{{ filteredSubscriptionPayments.length }}</p>
            <button @click="downloadSubscriptionPayments" class="px-3 py-1 text-sm bg-teal-600 text-white rounded hover:bg-teal-700">⬇ Export</button>
          </div>
          ...
          <div v-if="activePaymentTab === 'sales'">
            ...
            <div class="flex space-x-4 mb-2">
              ...
              <button @click="applySalesFilter" class="self-end px-3 py-1 bg-orange-600 text-white rounded hover:bg-orange-700 text-sm">Apply</button>
            </div>
            <p class="text-xl font-bold mb-2">{{ filteredSalesPayments.length }}</p>
            <button @click="downloadSalesPayments" class="px-3 py-1 text-sm bg-orange-600 text-white rounded hover:bg-orange-700">⬇ Export</button>
          </div>
