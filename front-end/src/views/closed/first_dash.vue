  ...
  <div class="p-6 bg-gray-100 min-h-screen">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="text-2xl font-semibold text-green-600">${{ stats.monthlyRevenue }}</p>
      </div>
      <div class="bg-white p-6 rounded-lg shadow-md">
...
<div class="bg-white p-6 rounded-lg shadow-md mb-8">
  ...
  <apexchart type="bar" height="350" :options="pricingChartOptions" :series="pricingSeries" />
</div>
    <!-- Charts -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      <div class="bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-lg font-semibold mb-4">Sales vs Rent Income</h2>
        <apexchart type="bar" height="300" :options="incomeChartOptions" :series="incomeSeries" />
      </div>
      <div class="bg-white p-6 rounded-lg shadow-md">
...
,
      recentTenants: [
        { id: 1, name: 'John Doe', property: 'Greenwood Apt. 302', type: 'Rent', date: '2025-08-01' },
        { id: 2, name: 'Maria Smith', property: 'Downtown Villa', type: 'Sale', date: '2025-08-03' },
        { id: 3, name: 'Ali Rahman', property: 'Sunset Condo 5A', type: 'Rent', date: '2025-08-04' }
      ]
    }
  }
}
