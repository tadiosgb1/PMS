            ...
            <tbody>
              <tr v-for="zone in filteredAndSortedZones" :key="zone.id" class="hover:bg-gray-100">
                ...
                <td class="border px-4 py-2 text-center space-x-2">
                  <button @click="editZone(zone)" class="text-blue-600 hover:text-blue-800"><i class="fas fa-edit"></i></button>
                  <button @click="askDeleteConfirmation(zone)" class="text-red-600 hover:text-red-800"><i class="fas fa-trash-alt"></i></button>
                </td>
              </tr>
...
export default {
  ...
  computed: {
    filteredAndSortedZones() {
      ...
      let filtered = this.zones.filter(z =>
